...
export default function SchoolSpecificParentRegistration() {
      ...
      <Card className="w-full max-w-2xl border-0 shadow-xl">
        <CardHeader className="text-center" style={{ backgroundColor: `${primaryColor}05` }}>
          ...
          <CardDescription className="text-gray-600">
            Create a parent account for {school.name}
          </CardDescription>
          <div 
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              ...
              disabled={loading}
            >
              {loading ? 'Creating Account...' : `Create Parent Account for ${school.name}`}
            </Button>
          </form>
        </CardContent>
      </Card>
