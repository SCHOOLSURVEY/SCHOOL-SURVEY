...
export default function SchoolSpecificTeacherDashboard() {
  ...
  const fetchTeacherData = async (teacherId: string) => {
    try {
      ...
      // Fetch teacher's courses (filtered by school)
      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-4 sm:space-y-0">
          <div className="min-w-0 flex-1">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Welcome to {school.name}</h1>
            <p className="text-sm sm:text-base text-muted-foreground mt-1">Teacher Dashboard - {currentUser.full_name}</p>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-9">
            ...
            <TabsTrigger value="intelligence">Survey Intelligence</TabsTrigger>
